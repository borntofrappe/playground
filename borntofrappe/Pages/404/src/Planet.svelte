<script>
  ...
  // svg appearance
  export let name;
  export let satellites = ["4", "", "0", "", "4", ""];
  export let colors = ["hsl(280, 65%, 20%)", "hsl(280, 70%, 30%)", "hsl(280, 75%, 45%)", "hsl(280, 80%, 50%)", "hsl(280, 90%, 55%)", "hsl(280, 92%, 65%)", "hsl(280, 95%, 70%)", "hsl(280, 95%, 80%)", "hsl(280, 100%, 90%)"];
  export let tilt = 0;
