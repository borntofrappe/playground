<script>
  ...
  export let colors = ["hsl(330, 100%, 95%)", "hsl(335, 100%, 86%)", "hsl(336, 93%, 77%)", "hsl(339, 90%, 67%)", "hsl(340, 90%, 55%)", "hsl(340, 85%, 46%)", "hsl(342, 92%, 39%)", "hsl(345, 96%, 33%)", "hsl(345, 95%, 27%)", "hsl(347, 100%, 19%)", "hsl(350, 100%, 8%)"];
  export let tilt = 0;
